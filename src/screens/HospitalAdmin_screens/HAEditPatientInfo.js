    ...
    return (
        <div>
            ...
            <Row >
                ...
                <Col sm={8} >
                    <Row>
                        <Col sm={12}><h1 className='haepi__title'>Edit Patient Information</h1> </Col>
                    </Row>
                    <hr className='haepi__hr'/>

                    <Row>
                        <Col sm={12}><h6 className='haepi__patientID'>Patient ID: {patientId}</h6> </Col>
                    </Row>

                    <FormContainer className='haepi__formContainer'>
                        {errorUpdate && <Message variant="danger">{errorUpdate}</Message>}
                        {loadingUpdate && <Loader />}
                        <Form onSubmit={submitHandler}>
                            <Form.Group controlId="name">
                                <Form.Label className='haepi__formLabel'>Patient Name</Form.Label>
                                <Form.Control
                                    type="text"
                                    placeholder="Enter name"
                                    value={name}
                                    onChange={(e) => setName(e.target.value)}
                                    className='haepi__formControl'>
                                </Form.Control>
                            </Form.Group>
                            ...
                            <Row>
                                <Col>
                                    <Form.Group controlId="bday">
                                        <Form.Label className='haepi__formLabel'>Date of Birth</Form.Label>
                                        <Form.Control
                                            type="date"
                                ...
                                <Col>
                                    ...
                                    <Form.Group controlId="district">
                                        <Form.Label className='haepi__formLabel'>District</Form.Label>
                                        <br />
                                        <select className="form-control haepi__formControl" value={district} name="district" onChange={(e) => setDistrict(e.target.value)}>
                            ...
                            <Row>
                                <Col>
                                    <Form.Group controlId="bloodtype">
                                        <Form.Label className='haepi__formLabel'>Blood Type</Form.Label>
                                        <select className="form-control haepi__formControl" value={blood_type} name="RATresult" onChange={(e) => setBloodType(e.target.value)}>
                                            <option >SELECT</option>
                                ...
                                <Col>
                                    <Form.Group controlId="gender">
                                        <Form.Label className='haepi__formLabel'>Gender</Form.Label>
                                        <select className="form-control haepi__formControl" value={gender} name="RATresult" onChange={(e) => setGender(e.target.value)}>
                                            <option >SELECT</option>
                            ...
                            <Form.Group controlId="address">
                                <Form.Label className='haepi__formLabel'>Address</Form.Label>
                                <Form.Control
                                    as="textarea"
                                    rows={3}
                                    type="text"
                            ...
                            <Form.Group controlId="contactnumber">
                                <Form.Label className='haepi__formLabel' >Contact Number</Form.Label>
                            </Form.Group>
                            <Row>
                                <Col>
                                    <PhoneInput
                            ...
                            <Row>
                                <Col>
                                    <Form.Group controlId="isvaccinated">
                                        <Form.Label className='haepi__formLabel'>Vaccination Details</Form.Label>
                                    ...
                                    <>
                                        <Col>
                                            <Form.Group controlId="testType">
                                                <Form.Label className='haepi__formLabel'>Vaccine Type</Form.Label>
                                                <br />
                                                <select className="form-control haepi__formControl" value={Type_vaccine} name="Type_vaccine" onChange={(e) => setTypevaccinated(e.target.value)}>
                                                    <option>SELECT</option>
                                        ...
                                        <Col>
                                            <Form.Group controlId="testType">
                                                <Form.Label className='haepi__formLabel'>No.Vaccine </Form.Label>
                                                <br />
                                                <select className="form-control haepi__formControl" value={Num_vaccine} name="Num_vaccine" onChange={(e) => setNumvaccinated(e.target.value)}>
                                                    <option >SELECT</option>
